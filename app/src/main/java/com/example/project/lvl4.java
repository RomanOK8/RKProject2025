...
public class lvl4 extends AppCompatActivity {//gfgjfd
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img.setBackgroundResource(R.drawable.lvl4background);
    ...
    private void initMediaPlayers() {
        ...
        mediaPlayerg=MediaPlayer.create(this, R.raw.lvl4music);
    ...
    private void startObstacleCreation() {
        ...
        createObstacleRunnable = new Runnable() {
            ...
            public void run() {
                createObstacle();
                obstacleHandler.postDelayed(this, 5000);
            }
        };
    ...
    public void pauseButton(View v) {
        ...
        intent.putExtra("levelClass", lvl4.class.getName());
    ...
    private void startCoinCreation() {
        if (!isGameOver) {
            ...
            Runnable createCoinRunnable = new Runnable() {
                ...
                public void run() {
                    createCoin();
                    coinGenerationHandler.postDelayed(this, 11500);
                }
            };
            coinGenerationHandler.postDelayed(createCoinRunnable, 11500);
        }
    }
